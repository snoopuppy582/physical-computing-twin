...
const desk=group('책상',[1.2,.75,.6],[1.3,0,-2.35],0xb8956b,'침대와 분리한 작업 영역입니다. 치수는 일반적인 1인용 책상을 가정했습니다.');
...
const chair=group('의자',[.45,.85,.45],[1.3,0,-1.65],0x7b8f86,'책상과 통로 사이에 놓은 고정 가구입니다. 이번 움직일 대상은 방문입니다.');
...
const kitchen=group('주방 수납대',[.6,.87,1.2],[1.8,0,0],0x93aa9a,'작은 원룸의 주방 영역을 가정했습니다.');
...
const windowGroup=group('창문',[1.1,1,.06],[-.7,1.35,-2.7],0x9cb5b7,'채광을 가정한 창문입니다. 실제 창문의 위치는 아직 측정하지 않았습니다.');
...
const door=group('방문',[.9,2,.04],[-.45,0,2.75],0x587f9d,'움직일 대상. 파란 박스 방문을 B의 상세 방문 모델로 구체화했습니다.');
